...
const NoteOptionsActionSheet = ({ handleChangeColor, handleDelete, handleManageLabels, selectedColor }) => {
  return (
    <View style={styles.container}>
      <View style={styles.colorOptions}>
        {['#FFFFFF', '#00E0E0', '#FF7070', '#FFD670', '#B6FFB6', '#A0E7FF', '#FFD6FF', '#C9FFD6'].map(color => (
          ...
          >
            {selectedColor === color && <Icon name="checkmark" size={20} color="white" />}
          </TouchableOpacity>
        ))}
